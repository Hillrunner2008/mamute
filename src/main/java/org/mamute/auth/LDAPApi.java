...
public class LDAPApi {
    ...
    /**
     * Ensure that required variables are set if LDAP auth is enabled
     */
    @PostConstruct
    public void init() {
    ...
    /**
     * Attempt to authenticate against LDAP directory. Accepts email addresses as well as plain usernames; emails will
     * have the '@mail.com' portion stripped off before read.
     *
     * @param username
     * @param password
     * @return
